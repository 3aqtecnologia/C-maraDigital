-- ============================================================
-- Atualização: Suporte a E-mail customizado no provisionamento
-- ============================================================

-- Dropar a versão antiga da função (assinatura com 8 argumentos)
DROP FUNCTION IF EXISTS public.provisionar_tenant(TEXT, TEXT, CHAR(2), TEXT, TEXT, tenant_plano, INTEGER, TEXT);

-- Recriar função recebendo p_admin_email
...
BEGIN
  ...
  -- Usar o e-mail fornecido ou gerar um padrão
  ...
  -- Gerar uma senha aleatória de 8 caracteres alfanumericos
